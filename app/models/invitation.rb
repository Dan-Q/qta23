class Invitation < ApplicationRecord
  ...
  KNOWN_TAGS = {
    ...
    'camping' => 'Invitee has indicated that they intend to camp. [self-managed]',
    'public_transport' => 'Invitee has indicated that they intend to travel using public transport [self-managed]',
